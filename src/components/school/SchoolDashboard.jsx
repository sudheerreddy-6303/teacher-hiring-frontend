            ...
            <div onClick={e => e.stopPropagation()}
              ...
              <div style={{ flex:1, overflow:"auto", padding:24 }}>
                {(() => {
                  ...
                  const fileUrl = link?.startsWith("http") ? link : link ? BASE + link : null;
              ...
              {resumeApplicant.resume_link && (
                <div style={{ padding:"14px 24px", borderTop:"1px solid #E5E7EB", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
                  ...
                  <div style={{ display:"flex", gap:10 }}>
                    ...
                    <a href={(() => {
                        const l = resumeApplicant.resume_link;
                        const B = (process.env.REACT_APP_API_URL||"http://localhost:5000/api").replace("/api","");
                        return l.startsWith("http") ? l : B + l;
                      })()}
